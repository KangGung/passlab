...
- 법령 기준 = 시험일 시행 중인 것. 화장품법 법률 20901호(2025-04-01 공포; 부칙 단서로 조문별 시행일 상이 — 제2조의3 화장품의 날 9/7은 **2025-04-01**, 제10조③~⑤ 점자·음성·수어영상 코드 표시는 **2025-07-02**, 제23조의2② 직구 화장품 공표는 2026-04-02) · 시행령 36176호 · 시행규칙 총리령 2109호(2026-04-02). (9/7 C2 검증에서 정정 — 이전 표기 '모두 2026-04-02'는 오기) 2025-08-01 천연·유기농 정부 인증제 폐지. **개인정보 보호법 법률 21445호 2026-09-11 시행(시험 8일 전)**, 「화장품 사용할 때의 주의사항 및 알레르기 유발성분 표시에 관한 규정」 2026-56호 2026-08-05 시행(벤조페논-3 주의사항 9/2). 미시행(12회 범위 밖): 21302호(12/31)·21709호(11/27)·21604호(2027-04-29, 일부 맞춤형판매업소 조제관리사 대체). 가이드 4판은 2025-08-01 법령 기준이므로 2026 개정분은 법령 원문으로 보강한다.
